...
class Orchestrator:
    ...
    def _on_worker_gateway_ready_change(self, ready: bool) -> None:
        ...
        # embedded / embedded_global / in_process+embedded: capacity from embedded pool;
        # hidden WS is overflow only.
    ...
    async def set_routing_active(self, active: bool) -> dict:
        ...
        if not active:
            ...
            if mode in ("embedded", "embedded_global"):
                should_ready = (
                    self.embedded_worker_pool is not None
                    and self.embedded_worker_pool.worker_count > 0
    ...
    async def _init_subnet_core_client(self) -> None:
        ...
        try:
            ...
            if gateway_mode in ("embedded", "embedded_global") or (
